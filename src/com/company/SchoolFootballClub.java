...
public class SchoolFootballClub extends FootballClub{
	...
	public SchoolFootballClub(String nameOfClub, String locationOfCLub, int numOfWin, int numOfDraw,
		...
		super(nameOfClub, locationOfCLub, numOfWin, numOfDraw, numOfDefeat, numOfScoredGoals,numOfReceivedGoals,goalDifference, numOfPoints, numOfPlayedMatches,date,position);
